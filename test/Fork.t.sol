...
contract ForkTest is Test {
    ...
    function test_DeployScriptSucceedsOnFork() external onlyFork {
        ...
        ShapesArtistAttribution attribution = ShapesArtistAttribution(s.artistAttribution());
        assertEq(attribution.shapes(), address(s), "attribution token mismatch");
        assertEq(attribution.artist(), s.artist(), "attribution artist mismatch");
        assertFalse(attribution.attested(), "attribution should start unsigned");
