...
| Linked libraries | `ComposeCompute`, `CopyValidation`, `EIP712Signature`, `GeometrySampling`, `InkGenes` | 304 | Externally linked deployments; stateless signature verification plus consensus-critical compose/split sampling and ink-gene logic |
...
| Artist attribution | `Shapes` | — | Immutable deployer attribution plus one directly stored EIP-712 release signature; no authority or economics |
