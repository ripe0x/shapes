...
- `AUDIT_PROMPT_v5.md` is historical because it is pinned to pre-D-35/D-36 source `dba4dbf`. Regenerate the authoritative audit brief against the final merged candidate before engaging the auditor.
