...
- `AUDIT_PROMPT_v4.md` prepares D-16 against exact current-main snapshot `020a85e`, covering the full Solidity system, release guards, D-32 parity and explicit D-17 disposition. No external auditor has been selected or contacted.
...
1. Select and engage an independent auditor for the fixed `020a85e` D-16 packet, then close or explicitly accept every finding.
