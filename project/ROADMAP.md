...
- External security audit required after issue #7, D-34, D-35 and D-36, with findings closed or accepted with rationale (D-16, D-17 folded in). `AUDIT_PROMPT_v6.md` pins exact tested flat-fee code commit `217498564f46667bc8fabce32be0a19c22d7e431`; selecting the independent auditor and completing the review remain open.
