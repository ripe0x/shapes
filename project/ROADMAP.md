...
- External security audit required after issue #7, D-34, D-35 and D-36, with findings closed or accepted with rationale (D-16, D-17 folded in). `audits/AUDIT_PROMPT_v6.md` pins exact merged flat-fee commit `1054db2455f7d6d3542a422130262bc872c34464`; selecting the independent auditor and completing the review remain open.
- Qualified legal review required before mainnet (D-15).
...
- COMPLETE FOR CURRENT RELEASE: deployment/lifecycle checks pass against a live mainnet fork; exact clean `eb9e8834553f199a4c94e7ba307686c8bd0d64e8` is live on Sepolia from block 11616988 with flat fee 10000000000000 wei. All eleven contracts/libraries are Etherscan-verified. Fly schema `shapes_sepolia_v3` and the production Netlify hybrid site are cut over and chain-validated.
