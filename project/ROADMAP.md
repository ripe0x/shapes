...
- DECIDED, IMPLEMENTATION PENDING: D-31 accepts non-reverting `exists` and stored `denomIndexOf`, rejects the `absorbedBy` reverse index, and requires size/lifecycle/interface evidence before deployment.
