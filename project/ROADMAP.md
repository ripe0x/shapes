...
Stop conditions: ERC-165 compatibility break; constructor/title/admin post-flight mismatch; any renderer parity failure.
...
- Key ceremony plan: admin structure, feeRecipient, title custody, and lock/renounce timing (D-05).
...
Acceptance: post-flight reads match intended config (ladder, feeBps, feeRecipient, admin, and title holder); site serves mainnet; indexer synced.
