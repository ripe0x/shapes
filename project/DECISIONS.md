...
- W-3 Port the 23 AuditPoC tests to current main as regression tests asserting the guards hold (from claude/shapes-security-audit-fa49c8 @ 6480f1c). P0/P1 boundary.
