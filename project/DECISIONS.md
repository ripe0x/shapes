...
- W-4 Land CI cost fixes from claude/docs-truth-and-size-gate (concurrency-cancel, dorny/paths-filter Foundry-skip, forge out/cache caching — the docs-truth half already landed as a161df9). Raised priority: CI is billing-dead (R15) and these cuts reduce the spend that likely killed it. P0 tail.
