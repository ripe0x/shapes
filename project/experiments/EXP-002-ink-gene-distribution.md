...
- Results:
  ...
  The exact homogeneous baseline also covers direct dust at 0.01 ETH: 33.3 expected mints. Under D-36's flat 0.001 ETH mainnet fee, its 333,333-mint 100 ETH result costs about 333.333 ETH in fees and parks about 100 ETH. The seed-aware retained-Dense heuristic result for Solid 100 is 40,064 dust mints, 95% CI **39,972–40,156**, p50 40,064, p95 40,640, and **40.064 ETH** in fees. The measured peak retained backing is **100.07 ETH mean**, p95 **100.15 ETH**, min 100.00 ETH, max 100.17 ETH.
...
- Conclusion: refuted for the seed-aware measured heuristic. Under the current flat fee, this retained-Dense policy reaches Solid 100 for about 40.064 ETH in fees, rather than the 333.333 ETH homogeneous baseline. A direct 100 ETH Shape can still be rerolled for 0.001 ETH per candidate, so this provenance-building experiment does not measure the cheapest high-tier artwork reroll. No ink constant was changed.
