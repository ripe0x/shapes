...
- P0 remaining: ONLY the hygiene pass (13 worktrees, ~45 branches, _to_delete/, stray superseded indexer/ draft) — destructive, awaiting user approval. W-3 closed (existing regressions cover all 23 PoC scenarios, verified passing). D-01 final branch-layout decision deferred to P2 entry; interim chain-1 guard landed (f7fd92b).
