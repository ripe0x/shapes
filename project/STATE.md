...
- Tests: D-26 branch has 438 passing contract tests and 4 fork-only skips without MAINNET_RPC_URL; focused attribution tests cover independent EIP-712 encoding, chain/hash/deployment replay rejection, canonical EOA signatures, EIP-7702 delegated EOAs, and ERC-1271 including an empty valid signature. Shapes has 287 bytes of EIP-170 runtime margin. Coverage remains ~96.75% line / 90.95% branch per the last x-ray run. No Echidna/Medusa/Halmos.
