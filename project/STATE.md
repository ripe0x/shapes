...
Current phase: P1 entry gate, with the corrected PR #2 owner/admin ABI merged; next is a fresh Sepolia deployment/readback (see `project/ROADMAP.md`).
