...
9. `Shapes.sol` stays under EIP-170. Any core addition requires both default and testnet size checks. D-34 leaves only 102/123 bytes of runtime margin respectively, so further core growth requires explicit byte recovery.
