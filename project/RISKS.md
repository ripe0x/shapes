...
- R3 (high, open) Untriaged security findings. AUDIT_FINDINGS.md + PoCs + unapplied patch may describe real vulnerabilities in code already live on Sepolia. Mitigation: P0 triage before any other contract merge.
