 ...
 * the docs and the FAQ are wallet-free and do not wait for deployment metadata or an RPC. "/" needs
...
export function ShapesProviders({
  ...
  const skipsChain = pathname === "/play" || isDocs || isFaq || (isIndex && !chainOnIndex);
