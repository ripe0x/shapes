...
/**
 * The seed a decompose assigns to its i-th child: `keccak256(abi.encodePacked(parentSeed, i))`,
 * mirroring `Shapes.decompose`. No block data enters, so the whole decompose tree is fixed the
 ...
 */
export function decomposeChildSeed(parentSeed: bigint, index: number | bigint): bigint {
