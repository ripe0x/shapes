...
import {Round03Rand, seed32Of} from "./rand.ts";
import {unitsAt, cellCountAt, DENOMINATIONS, LABELS} from "./denominations.ts";
import {GENE_PROBABILITY} from "./ink.ts";
import {
  CANONICAL,
  DESCRIPTION,
...
import {decodeModules, encodeModules, isValidModuleArray} from "./moduleCodec.ts";
